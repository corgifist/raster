...
struct ImVec4
{
    ...
    constexpr ImVec4(float _i) : x(_i), y(_i), z(_i), w(_i) {}
...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, bool artificial_child = false);
    IMGUI_API void          End();
