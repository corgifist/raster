#include "color4_attribute.h"

namespace Raster {
    Color4Attribute::Color4Attribute() {
    ...
    std::any Color4Attribute::AbstractInterpolate(std::any t_beginValue, std::any t_endValue, float t_percentage, float t_frame, Composition* composition) {
    ...
    void Color4Attribute::RenderKeyframes() {
    ...
    std::any Color4Attribute::AbstractRenderLegend(Composition* t_composition, std::any t_originalValue, bool& isItemEdited) {
    ...
    void Color4Attribute::AbstractRenderDetails() {
    ...
    void Color4Attribute::AbstractRenderPopup() {
    ...
    Json Color4Attribute::SerializeKeyframeValue(std::any t_value) {
    ...
    std::any Color4Attribute::LoadKeyframeValue(Json t_value) {
...
extern "C" {
    RASTER_DL_EXPORT Raster::AbstractAttribute SpawnAttribute() {
        return (Raster::AbstractAttribute) std::make_shared<Raster::Color4Attribute>();
    }
