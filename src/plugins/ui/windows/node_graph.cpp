...
namespace Raster {
    ...
    Json NodeGraphUI::AbstractSerialize() {
        return {};
    }

    void NodeGraphUI::AbstractLoad(Json t_data) {

    }

    void NodeGraphUI::AbstractRender() {
        ...
        if (ImGui::Begin(FormatString("%s %s###%i", ICON_FA_CIRCLE_NODES, Localization::GetString("NODE_GRAPH").c_str(), id).c_str(), &open)) {
