...
// NOTE: This is a modified version of Boost Source Location library
//       It was modified in order to be header-only library and be independent from any other Boost headers
