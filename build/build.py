...
raster_node_category          = "-lraster_node_category"         # TODO: get rid of this module and merge it into raster_comon
raster_dynamic_math           = "-lraster_dynamic_math"          # TODO: get rid of this module and merge it into raster_common
...
build_modules = [
    ...
    ["ui", shared, ui_deps],
    ["app", shared, [raster_common, raster_ImGui, raster_gpu, raster_ui, raster_font, raster_compositor, raster_node_category, raster_dispatchers_installer, nfd, raster_avcpp, get_library(ffmpeg_libraries_list), raster_audio]],
    ...
    ["audio/decode_audio_asset", node, [raster_common, raster_avcpp, raster_audio, raster_node_category, get_library(ffmpeg_libraries_list)]],
